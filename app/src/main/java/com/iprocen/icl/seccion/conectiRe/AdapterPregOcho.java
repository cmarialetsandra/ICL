...
public class AdapterPregOcho extends RecyclerView.Adapter<AdapterPregOcho.ViewHolder>{

    private List<ConectiRe> coList;

    public AdapterPregOcho(List<ConectiRe> coList) {
        this.coList = coList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getDmz());
