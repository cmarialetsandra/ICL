...
public class AdapterPregCinco extends RecyclerView.Adapter<AdapterPregCinco.ViewHolder>{
    ...
    public AdapterPregCinco(List<CablePre> caList) {
        this.caList = caList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getLongitud());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putString("tamanio", opc.getTamanio());
                bundle.putString("posicion", opc.getPosicion());
                bundle.putString("tipo", opc.getTipo());
                bundle.putString("orientacion", opc.getOrientacion());
                bundle.putString("longitud", opc.getLongitud());
