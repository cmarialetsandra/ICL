...
public class AdapterPregCinco extends RecyclerView.Adapter<AdapterPregCinco.ViewHolder>{
    ...
    public AdapterPregCinco(List<SwitchesAd> swList) {
        this.swList = swList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getCaracteristica());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putString("puerto_cobre", opc.getPuerto_cobre());
                bundle.putString("puerto_fibra", opc.getPuerto_fibra());
                bundle.putString("puerto_combinado", opc.getPuerto_combinado());
                bundle.putString("velocidad", opc.getVelocidad());
                bundle.putString("caracteristica", opc.getCaracteristica());
