...
public class AdapterPregDiez extends RecyclerView.Adapter<AdapterPregDiez.ViewHolder>{
    ...
    public AdapterPregDiez(List<ConectiRe> coList) {
        this.coList = coList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getFailover());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("dmz", opc.getDmz());
                bundle.putString("celular_gps", opc.getCelular_gps());
                bundle.putString("failover", opc.getFailover());
                PregOnceFragment fragment = new PregOnceFragment();
