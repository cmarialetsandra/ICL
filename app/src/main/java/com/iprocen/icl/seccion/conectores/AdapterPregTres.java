...
public class AdapterPregTres extends RecyclerView.Adapter<AdapterPregTres.ViewHolder>{
    ...
    public AdapterPregTres(List<Conector> coList) {
        this.coList = coList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getTecnologia());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putString("heavycon", opc.getHeavycon());
                bundle.putString("polos", opc.getPolos());
