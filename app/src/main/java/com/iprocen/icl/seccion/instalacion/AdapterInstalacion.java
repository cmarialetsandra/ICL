...
public class AdapterInstalacion extends RecyclerView.Adapter<AdapterInstalacion.ViewHolder>{

    private List<Instalacion> inList;

    public AdapterInstalacion(List<Instalacion> inList) {
        this.inList = inList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getTipo());
