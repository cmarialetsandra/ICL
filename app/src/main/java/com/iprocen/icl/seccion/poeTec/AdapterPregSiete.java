...
public class AdapterPregSiete extends RecyclerView.Adapter<AdapterPregSiete.ViewHolder>{
    ...
    public AdapterPregSiete(List<PoeTec> ptList) {
        this.ptList = ptList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getCampo6());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("campo5", opc.getCampo5());
                bundle.putString("campo6", opc.getCampo6());
                ResultadoUnoFragment fragment = new ResultadoUnoFragment();
