...
public class PregOchoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txt_preg.setText(R.string.pg8ca);

        btn_opc1 = (Button) view.findViewById(R.id.btn_opc1);
        btn_opc1.setText(R.string.frontal);
        ...
        btn_opc2.setText(R.string.posterior);
    ...
    private void cambioFragment(int montaje){
        ...
        bundle.putInt("montaje", montaje);
        PregNueveFragment fragment = new PregNueveFragment();
