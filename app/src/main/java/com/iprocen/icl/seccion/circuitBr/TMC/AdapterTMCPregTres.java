...
public class AdapterTMCPregTres extends RecyclerView.Adapter<AdapterTMCPregTres.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterTMCPregTres(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getCurva());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("nmro_polos", opc.getNmro_polos());
                bundle.putString("curva", opc.getCurva());
                TMCCuatroFragment fragment = new TMCCuatroFragment();
