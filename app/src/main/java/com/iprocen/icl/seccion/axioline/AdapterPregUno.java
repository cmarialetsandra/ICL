...
public class AdapterPregUno extends RecyclerView.Adapter<AdapterPregUno.ViewHolder>{
    ...
    public AdapterPregUno(List<Axioline> axList) {
        this.axList = axList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if (opc.getTipo() == 1){
            holder.txtOpc.setText(R.string.acompladores);
            holder.txtOpc.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AcopladorFragment fragment = new AcopladorFragment();
        ...
        }else if (opc.getTipo() == 2){
            holder.txtOpc.setText(R.string.controladores);
            holder.txtOpc.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            holder.txtOpc.setText(R.string.modulos_es);
            holder.txtOpc.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    EntradaSalidaFragment fragment = new EntradaSalidaFragment();
                    fragment.setArguments(bundle);
                    FragmentTransaction transaction = ((AppCompatActivity) holder.context).getSupportFragmentManager().beginTransaction()
                            .replace(R.id.nav_host_fragment, fragment).disallowAddToBackStack();
                    transaction.commit();
