...
public class UPSAdapterPregCinco extends RecyclerView.Adapter<UPSAdapterPregCinco.ViewHolder>{

    private List<SAI_UPS> saiList;

    public UPSAdapterPregCinco(List<SAI_UPS> saiList) {
        this.saiList = saiList;
    }

    @NonNull
    @Override
    public UPSAdapterPregCinco.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_result_3, parent,false);
        UPSAdapterPregCinco.ViewHolder holder = new UPSAdapterPregCinco.ViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final UPSAdapterPregCinco.ViewHolder holder, int position) {
