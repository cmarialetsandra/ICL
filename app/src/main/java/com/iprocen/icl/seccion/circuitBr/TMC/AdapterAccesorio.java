...
public class AdapterAccesorio extends RecyclerView.Adapter<AdapterAccesorio.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterAccesorio(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getAccesorio());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putInt("tipo", opc.getTipo());
                bundle.putString("accesorio", opc.getAccesorio());
                AccesorioDosFragment fragment = new AccesorioDosFragment();
