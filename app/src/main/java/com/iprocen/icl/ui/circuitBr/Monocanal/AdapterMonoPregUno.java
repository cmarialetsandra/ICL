package com.iprocen.icl.ui.circuitBr.Monocanal;
...
import com.iprocen.icl.ui.circuitBr.Multicanal.MultiDosFragment;

import java.util.List;

public class AdapterMonoPregUno extends RecyclerView.Adapter<AdapterMonoPregUno.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterMonoPregUno(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MonoDosFragment fragment = new MonoDosFragment();
