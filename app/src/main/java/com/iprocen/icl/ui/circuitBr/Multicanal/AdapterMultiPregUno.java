...
public class AdapterMultiPregUno extends RecyclerView.Adapter<AdapterMultiPregUno.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterMultiPregUno(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getCanal());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MultiDosFragment fragment = new MultiDosFragment();
