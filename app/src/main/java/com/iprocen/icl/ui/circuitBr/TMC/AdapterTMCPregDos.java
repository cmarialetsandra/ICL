...
public class AdapterTMCPregDos extends RecyclerView.Adapter<AdapterTMCPregDos.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterTMCPregDos(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setText(opc.getNmro_polos());
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TMCTresFragment fragment = new TMCTresFragment();
