...
public class AdapterTMCPregCuatro extends RecyclerView.Adapter<AdapterTMCPregCuatro.ViewHolder>{

    private List<CircuitBr> cbList;

    public AdapterTMCPregCuatro(List<CircuitBr> cbList) {
        this.cbList = cbList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.txtOpc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TMCCincoFragment fragment = new TMCCincoFragment();
